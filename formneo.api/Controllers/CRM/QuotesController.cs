...
namespace vesa.api.Controllers.CRM
{
	...
	public class QuotesController : ControllerBase
	{
		...
		[HttpPost]
		public async Task<IActionResult> Create([FromBody] QuoteDto dto){var created=await _service.CreateAsync(dto);return Ok(created);}
		[HttpPut]
		public async Task<IActionResult> Update([FromBody] QuoteDto dto){var updated=await _service.UpdateAsync(dto);if(updated==null)return NotFound();return Ok(updated);}
		[HttpDelete("{id}")]
