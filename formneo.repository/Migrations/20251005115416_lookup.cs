...
namespace formneo.repository.Migrations
{
    ...
    public partial class lookup : Migration
    {
        ...
        {
            // Eski ve hatalı FK/tabloları güvenli şekilde temizle
            ...
            // Yanlış adlandırılmış tabloları düşür
            ...
            // Varsa önce doğru isimli tabloları da temizle (idempotent kurulum için)
            ...
            // Customers tablolarındaki eski FK'lar sorun çıkarıyordu; buradan tekrar eklemiyoruz
        }

        /// <inheritdoc />
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            // TenantLookup tablolarını geri al
            migrationBuilder.Sql("DROP TABLE IF EXISTS \"TenantLookupItems\" CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS \"TenantLookupCategories\" CASCADE;");
            migrationBuilder.Sql("DROP TABLE IF EXISTS \"TenantLookupModules\" CASCADE;");
        }
