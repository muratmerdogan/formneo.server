...
{
    public class BudgetJobCodeRequestInsertDto
    {
        ...
        [Required(ErrorMessage = "Görev Seviyesi bilgisi gereklidir")]
        ...
        [Required(ErrorMessage = "Custom Job Code Bilgisi gereklidir")]
        ...
        [Required(ErrorMessage = "Görev Birimi bilgisi gereklidir")]
