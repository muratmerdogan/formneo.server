...
namespace formneo.core.DTOs.Budget.NormCodeRequest
{
    ...
    public class BudgetNormCodeRequestListDtoResult
    {
        public List<BudgetNormCodeRequestListDto> BudgetNormCodeRequestListDtoList { get; set; }

        public int Count { get; set; }

    }
    public class BudgetNormCodeRequestListDto
    {
        ...
        public string InternalEmploymentTypeText { get; set; }
