...
namespace formneo.core.DTOs.Inventory
{
    ...
    {
        // 1. Genel Bilgiler
        public Guid Id { get; set; } // Envanter No / Varlık Kodu
        ...
        public virtual UserAppDto? UserApp { get; set; }
        public Guid? TicketDepartmentId { get; set; }
        public virtual TicketDepartmensListDto? TicketDepartment { get; set; }
